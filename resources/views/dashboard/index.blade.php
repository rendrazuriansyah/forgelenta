            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="index.html" class='sidebar-link'>
                                <i class="bi bi-calendar2-minus-fill"></i> <span>Leave Request</span>
                            </a>
                        </li>
        ...
        <div id="main">
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div class="float-end">
                        <p><svg class="bi me-1" width="1em" height="1em" fill="currentColor"><use xlink:href="{{ asset('mazer/assets/static/images/bootstrap-icons.svg') }}#github"/></svg><a href="https://github.com/rendrazuriansyah">rendrazuriansyah</a></p>
                    </div>
                </div>
            </footer>
        </div>
