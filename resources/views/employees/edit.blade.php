                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email"
                                        ...
                                        placeholder="e.g., email@example.com" value="{{ old('email', $employee->email) }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address"
                                        placeholder="Enter full address (Street, City, State, Zip)" rows="3">{{ old('address', $employee->address) }}
                                    </textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="birth_date"
                                        ...
                                        name="birth_date" placeholder="Select birth date"
                                        value="{{ old('birth_date', $employee->birth_date) }}" readonly>
                                    @error('birth_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="hire_date"
                                        ...
                                        name="hire_date" placeholder="Select hire date"
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="salary"
                                        ...
                                        placeholder="e.g., 50000" value="{{ old('salary', $employee->salary) }}">
