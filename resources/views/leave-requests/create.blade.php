    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="{{ route('leave-requests.store') }}" method="post">
                        @csrf
                        @method('post')
                        <div class="row">
                                    ...
                                    <select id="leave_type" class="form-control @error('leave_type') is-invalid @enderror"
                                        ...
                                        @foreach ($leave_types as $leave_type)
                                            <option value="{{ $leave_type }}"
                                                {{ old('leave_type') == $leave_type ? 'selected' : '' }}>
                                                {{ $leave_type }}</option>
                                        @endforeach
                                    </select>
                                    @error('leave_type')
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="start_date"
                                        ...
                                        name="start_date" placeholder="Select Date" value="{{ old('start_date') }}"
                                        readonly>
                                    @error('start_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="end_date"
                                        ...
                                        name="end_date" placeholder="Select Date" value="{{ old('end_date') }}" readonly>
                                    @error('end_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
